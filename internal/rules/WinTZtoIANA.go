...
// Taken at https://github.com/thlib/go-timezone-local/blob/main/tzlocal/tzmapping.go
// I don't use the package since this structure is only available to windows Go builds of this package.
